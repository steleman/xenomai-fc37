...
%define specrpmversion 6.5.13
%define specversion 6.5.13
%define patchversion 6.5
%define pkgrelease 300
%define kversion 6
%define tarfile_release 6.5.13
# This is needed to do merge window version magic
%define patchlevel 5
# This allows pkg_release to have configurable %%{?dist} tag
%define specrelease 300%{?buildid}%{?dist}
# This defines the kabi tarball version
%define kabiversion 6.5.13
...
Patch3: patch-%{patchversion}-uapi-evl.patch
%endif
...
ApplyOptionalPatch patch-%{patchversion}-uapi-evl.patch
%endif
...
#
%changelog
* Tue Nov 28 2023 Augusto Caringi <acaringi@redhat.com> [6.5.13-0]
- Drop F39 and F38 from the 6.5 release_targets (Justin M. Forbes)
- Linux v6.5.13
